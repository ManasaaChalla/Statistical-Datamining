...
pairs(College[ ,2:18],main="Scatter plots of all pairs of continuous variables of College Dataset") #scatterplot of the continuous variables in the data set
...
graphics.off()
pairs(Auto[1:7], main="Scatter plots of all pairs of continuous variables of Auto Dataset")
